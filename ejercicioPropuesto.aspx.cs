...
namespace EjercicioPropuesto
{
    public partial class WebForm1 : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            double monto, cuotas, interes, seguro, resp;
            ...
            resp = (monto + monto * interes / 100 + monto * seguro / 100) / cuotas;
            respuesta.Text = "EL SR(A)" + nombre.Text + " " + apellido.Text + " debera pagar " + resp + " por un periodo de "
            + cuotas + " meses.con un interes mensual de de " + ((interes / 100 * monto) / cuotas) + " y un seguro mesual de "
            + ((seguro / 100 * monto) / cuotas) ; ;
        }
    }
}